...
The code in simpleUI.py is final. Build the UI and take a screenshot.
...
Making your first UI using a reference:
    ...
    1. Choose an image reference of a tool (best to pick a DCC plugin)
    2. Reconstruct the UI in the designer. Make sure to use layouts.
    3. Add (real or pseudo) functionalities to the tool.

A great opportunity to play with all the different widgets and connections.
NOTE: You can skip it or combine it with 04 if you don't need extra practise.
...
Create a UI for your application via code or designer.
    ...
    "Take a look to the files within the toolkit folder, I dropped there the python file, 
    file.ui, video, images, and the utils folder"                               <<<<<<<<
...
# 05. FINAL WORDS
#*******************************************************************************
After submitting the final assignment watch the Final Words chapter.
